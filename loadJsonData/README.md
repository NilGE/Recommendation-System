...
hadoop jar loadJsonData-0.0.1-SNAPSHOT.jar com.nilge.hadoop.loadJsonData.mapreduce.LoadJsonData project/batch/loadJsonData/input/business_sample project/batch/loadJsonData/output/business_sample
